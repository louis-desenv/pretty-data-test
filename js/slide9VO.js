document.addEventListener("DOMContentLoaded", function() {
    ...
    if (gridContainer) {
        ...
        for (let i = 0; i < 17; i++) { 
            ...
            itemUpDiv.style.height =Math.floor(Math.random() * 100+12)+ "px" ;           
     ...
     if (gridContainerBottom) {
        ...
        for (let i = 0; i < 17; i++) { 
            ...
            itemDownDiv.style.height =Math.floor(Math.random() * 100 +12) + "px" ;            
            itemDownDiv.style.transform = 'rotate(180deg)';
